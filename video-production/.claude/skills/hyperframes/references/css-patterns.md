...
Pure CSS + GSAP implementations of all five MarkerHighlight.js drawing modes. Use these for deterministic rendering in HyperFrames compositions â€” no external library dependency, full GSAP timeline control.

## Table of Contents

- [1. Highlight Mode](#1-highlight-mode) â€” Yellow marker sweep behind text
- [2. Circle Mode](#2-circle-mode) â€” Hand-drawn ellipse around text
- [3. Burst Mode](#3-burst-mode) â€” Radiating lines from text
- [4. Scribble Mode](#4-scribble-mode) â€” Chaotic scribble over text
- [5. Sketchout Mode](#5-sketchout-mode) â€” Rough rectangle outline

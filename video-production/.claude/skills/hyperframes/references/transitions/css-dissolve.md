...
Dissolve with blur + scale shift. **Scale blur amount by energy** â€” see SKILL.md "Blur Intensity by Energy" section. The examples below show the medium (default) version. For calm compositions, increase to 20-30px with a 0.3-0.5s hold at peak blur. For high-energy, decrease to 3-6px with no hold.
...
**Calm (wellness, luxury) â€” heavy blur, holds at abstract color:**
...
**Calm â€” slow rack focus with long hold at peak defocus:**

...
- **0.7-0.8** â€” Tutorial, complex content
- **1.0** â€” Natural pace (default)
- **1.1-1.2** â€” Intros, upbeat content
- **1.5+** â€” Rarely appropriate
...
npx hyperframes transcribe narration.wav  # â†’ transcript.json with word-level timestamps
```

...
- `frames[i].bands[]` â€” frequency band amplitudes, 0-1. Index 0 = bass, higher = treble.
...
Any GSAP-tweenable property works â€” `clipPath`, `filter`, SVG attributes, CSS custom properties.
...
```js
// âœ… Correct â€” sample every frame
...
// âŒ Wrong â€” single tween, doesn't react to audio
...
- **Subtlety for text** â€” 3-6% scale variation, soft glow. Heavy pulsing makes text unreadable.
- **Go bigger on non-text** â€” backgrounds and shapes can handle 10-30% swings.
- **Match the energy** â€” corporate = subtle; music video = dramatic.
- **Deterministic** â€” pre-extracted data, no Web Audio API, no runtime analysis.

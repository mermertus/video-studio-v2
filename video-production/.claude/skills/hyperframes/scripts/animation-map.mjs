#!/usr/bin/env node
// animation-map.mjs â€” HyperFrames animation map for agents
//
...
try {
  ...
  // â”€â”€ Composition-level analysis â”€â”€
...
// â”€â”€â”€ Seek helper â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Timeline introspection â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Tween description (the key output for agents) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function describeTween(tw, props, bboxes, flags) {
  ...
  if (first && last && first.opacity !== undefined && last.opacity !== undefined) {
    ...
    if (Math.abs(o2 - o1) > 0.1) {
      ...
      else parts.push(`opacity ${o1.toFixed(1)}â†’${o2.toFixed(1)}`);
    }
  }
  ...
  if (first && last) {
    ...
    if (Math.abs(dw) > 5) parts.push(`width ${first.w}â†’${last.w}px`);
    if (Math.abs(dh) > 5) parts.push(`height ${first.h}â†’${last.h}px`);
  }
  ...
  if (last && !last.missing) {
    parts.push(`ends at (${last.x}, ${last.y}) ${last.w}Ã—${last.h}px`);
  }
...
// â”€â”€â”€ Flag computation â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Composition-level analysis â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function buildTimeline(tweens, duration) {
  ...
  lines.push("Timeline (" + duration.toFixed(1) + "s, each char â‰ˆ " + secPerCol.toFixed(2) + "s):");
  lines.push("  " + "0s" + " ".repeat(cols - 8) + duration.toFixed(0) + "s");
  lines.push("  " + "â”¼" + "â”€".repeat(cols - 1) + "â”¤");
  ...
  for (const tw of tweens) {
    ...
    const bar =
      " ".repeat(startCol) +
      "â–ˆ".repeat(Math.max(1, endCol - startCol)) +

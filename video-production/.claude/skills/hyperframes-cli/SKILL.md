...
1. **Scaffold** â€” `npx hyperframes init my-video`
2. **Write** â€” author HTML composition (see the `hyperframes` skill)
3. **Lint** â€” `npx hyperframes lint`
4. **Preview** â€” `npx hyperframes preview`
5. **Render** â€” `npx hyperframes render`

Lint before preview â€” catches missing `data-composition-id`, overlapping tracks, unregistered timelines.

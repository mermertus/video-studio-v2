...
**CSS** â€” paste the `.shimmer-sweep-target` and `.shimmer-mask` rules from the snippet.

**JS** â€” paste the auto-injection script (before timeline code):

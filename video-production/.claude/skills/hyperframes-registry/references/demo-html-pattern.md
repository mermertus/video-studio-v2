...
1. **Preview fixture** â€” the CI preview pipeline renders the demo to generate thumbnail images and preview videos for the catalog docs page.

2. **Usage example** â€” the demo shows the component effect applied to representative content, serving as a working reference.
...
<html lang="en">
  <head>
    ...
    <title>Component Name â€” Demo</title>
...
- The demo is self-contained â€” all CSS and JS from the snippet is inlined
...
The `demo.html` is NOT installed by `hyperframes add` â€” it exists only in the registry for preview generation and as a reference.

...
Components are effect snippets â€” HTML, CSS, and optionally JS that you merge directly into an existing composition. Unlike blocks, components have no standalone timeline; they participate in the host composition's timeline.
...
4. Copy the parts into your host composition:
   - **HTML elements** â€” inside your `<div data-composition-id="...">`
   - **CSS styles** â€” into your composition's `<style>` block
   - **JS setup** â€” into your composition's `<script>`, before your timeline code
   - **Timeline calls** â€” into your GSAP timeline (if the component exposes them)
...
Then paste the CSS keyframes and `.grain-texture` rule into your styles. No GSAP timeline calls needed â€” the grain animates via CSS `@keyframes`.

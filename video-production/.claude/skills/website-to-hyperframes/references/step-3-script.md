...
**Before writing, re-read DESIGN.md** â€” specifically the Overview and Components sections. The script should reference real product features, real stats, and real components that the website highlights. Use exact numbers from `extracted/visible-text.txt`.

The script is the backbone. Everything downstream â€” scene durations, animation timing, beat pacing â€” comes from the narration. Write it before the storyboard.
...
- The script should feel SHORTER than the video â€” visual breathing room matters
...
- Vary sentence length â€” short punchy phrases mixed with longer flowing ones
...
1. **Hook** â€” what's surprising or impressive about this product? A bold claim, a provocative question, a contrast, or a striking number. This is the opening line. **Vary the hook type** â€” don't default to a stat every time.
2. **Story** â€” what does the product do? Who uses it? Keep it concrete.
3. **Proof** â€” stats, customer names, social proof. Real numbers from the website.
4. **CTA** â€” what should the viewer do? "Start building at stripe dot com."
...
- **A number that shocks**: "Nearly two trillion dollars." (Use sparingly â€” not every video should open with a stat.)
...
Drop in music, sound effects, footage â€” it all composes together.
...
Note: ~140 words for 62 seconds â€” that's 2.3 words/sec, leaving room for pauses and visual breathing.
